...
public class PatientMessengerController implements Initializable {
    ...
    private void loadDashboardStats() {
        ...
        List<Conversation> convs = conversationService.getConversationsForPatient(sessionManager.getCurrentUserId());
    ...
    private void handleNewConversation() {
        ...
        Conversation existing = conversationService.getConversationBetween(
            selectedDoctor.getId(), sessionManager.getCurrentUserId()
        );
        ...
        if (existing != null) {
            ...
            conv.setUserId(sessionManager.getCurrentUserId());
