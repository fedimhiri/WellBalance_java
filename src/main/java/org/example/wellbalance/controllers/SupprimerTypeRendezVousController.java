...
public class SupprimerTypeRendezVousController extends BaseAdminController {
    ...
    public void supprimerTypeRendezVous() {
        ...
        if (!confirmDeletion("Supprimer ce type ?")) {
            return;
        }

        service.supprimer(selectedType.getId());
        showSuccess("Type de rendez-vous supprime avec succes.");
        loadData();
        selectedType = null;
    }
    ...
    private void refreshFilters() {
        ...
        tableSupport.apply(type -> matchesSearch(type, search) && matchesCategorie(type, categorie));
    }
