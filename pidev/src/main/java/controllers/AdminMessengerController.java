...
public class AdminMessengerController implements Initializable {
    ...
    // Header elements removed - using application's header/sidebar
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // Set user info - header removed, using application's header
    ...
    private void loadDashboardStats() {
        ...
        List<Conversation> convs = conversationService.getConversationsForDoctor(Session.getCurrentUser().getId());
        ...
        for (Conversation c : convs) {
            ...
            for (Message m : msgs) {
                if (m.getSenderId() == Session.getCurrentUser().getId()) sent++;
                else received++;
    ...
    private HBox createMessageBox(Message msg) {
        ...
        bubble.setOnMouseClicked(e -> {
            if (e.getClickCount() == 2) {
                ...
                if (Session.getCurrentUser().getRoles() != null && Session.getCurrentUser().getRoles().contains("ROLE_ADMIN")) {
                    reactorName = "Dr.";
                }
    ...
    public void goToDashboard(javafx.event.ActionEvent event) {
        navigateToPage("/fxml/admin_dashboard.fxml", "Admin Dashboard");
    }

    @FXML
    public void goToFrontOffice(javafx.event.ActionEvent event) {
        navigateToPage("/fxml/front.fxml", "Front Office");
    }

    @FXML
    public void goToMyProfile(javafx.event.ActionEvent event) {
        navigateToPage("/fxml/edit_profile.fxml", "Mon Profil");
    }

    @FXML
    public void goToSessions(javafx.event.ActionEvent event) {
        navigateToPage("/fxml/user_sessions.fxml", "Sessions utilisateurs");
    }
